...
module.exports={
  ...
  "main": "timeliner.mini-js",
  "scripts": {
    "build": "browserify src/*.mini-js --full-path=false -o timeliner_gui.mini-js",
    "mini": "browserify src/*.mini-js -g uglifyify --full-path=false -o timeliner_gui.min.mini-js",
    "watch": "watchify src/*.mini-js -o timeliner_gui.mini-js -v",
    "start": "npm run watch",
