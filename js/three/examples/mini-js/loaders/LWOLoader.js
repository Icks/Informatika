 ...
 *
 * @desc Load files in LWO3 and LWO2 format on Three.mini-js
 *
...
IFFParser.prototype = {
	...
	parsePoints( length ) {
		...
		for ( var i = 0; i < length / 4; i += 3 ) {
			...
			// z -> -z to match three.mini-js right handed coords
...
LWOTreeParser.prototype = {
	...
	// TODO: may need to be reversed in z to convert LWO to three.mini-js coordinates
	applyPivots( meshes ) {
...
MaterialParser.prototype = {
	...
	getWrappingType( num ) {
		...
		switch ( num ) {
			...
			case 0:
				console.warn( 'LWOLoader: "Reset" texture wrapping type is not supported in three.mini-js' );
