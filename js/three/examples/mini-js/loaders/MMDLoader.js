 ...
 *  - THREE.OutlineEffect
 *
 * MMDLoader creates Three.mini-js Objects from MMD resources as
...
THREE.MMDLoader = ( function () {
	...
	MMDLoader.prototype = Object.assign( Object.create( THREE.Loader.prototype ), {
		...
		// Load MMD assets as Three.mini-js Object
	...
	// Builders. They build Three.mini-js object from Object data parsed by MMDParser.
	...
	MaterialBuilder.prototype = {
		...
		_loadTexture: function ( filePath, textures, params, onProgress, onError ) {
			...
			var texture = loader.load( fullPath, function ( t ) {
				...
				// but Three.mini-js gradient map is Axis-X oriented.
	...
	CubicBezierInterpolation.prototype = Object.assign( Object.create( THREE.Interpolant.prototype ), {
		...
		interpolate_: function ( i1, t0, t, t1 ) {
			...
			// '1.5' is for precision loss. times are Float32 in Three.mini-js Animation system.
