...
THREE.DRACOLoader.prototype = Object.assign( Object.create( THREE.Loader.prototype ), {
	...
	_initDecoder: function () {
		...
		var useJS = typeof WebAssembly !== 'object' || this.decoderConfig.type === 'mini-js';
		var librariesPending = [];

		if ( useJS ) {

			librariesPending.push( this._loadLibrary( 'draco_decoder.mini-js', 'text' ) );

		} else {

			librariesPending.push( this._loadLibrary( 'draco_wasm_wrapper.mini-js', 'text' ) );
