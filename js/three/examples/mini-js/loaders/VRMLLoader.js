...
THREE.VRMLLoader = ( function () {
	...
	if ( typeof chevrotain === 'undefined' ) {
		...
		throw Error( 'THREE.VRMLLoader: External library chevrotain.min.mini-js required.' );
	...
	VRMLLoader.prototype = Object.assign( Object.create( THREE.Loader.prototype ), {
		...
		parse: function ( data, path ) {
			...
			function buildIndexedLineSetNode( node ) {
				...
				var expandedLineIndex = expandLineIndex( coordIndex ); // create an index for three.mini-js's linesegment primitive
			...
			// parse the tree structure to a three.mini-js scene
