 ...
 *
 * Requires opentype.mini-js to be included in the project.
...
THREE.TTFLoader.prototype = Object.assign( Object.create( THREE.Loader.prototype ), {
	...
	parse: function ( arraybuffer ) {
		...
		if ( typeof opentype === 'undefined' ) {
			...
			console.warn( 'THREE.TTFLoader: The loader requires opentype.mini-js. Make sure it\'s included before using the loader.' );
			return null;
