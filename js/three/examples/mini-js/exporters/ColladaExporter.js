	...
	parse: function ( object, onDone, options ) {
		...
		function processMaterial( m ) {
			...
			if ( matid == null ) {
				...
				// in three.mini-js alpha maps are black and white, but collada expects the alpha
		...
		var dae =
			...
			(
				'<contributor>' +
				'<authoring_tool>three.mini-js Collada Exporter</authoring_tool>' +
