...
THREE.GLTFExporter.prototype = {
	...
	parse: function ( input, onDone, options ) {
			...
			if ( mesh.morphTargetInfluences !== undefined && mesh.morphTargetInfluences.length > 0 ) {
				...
				for ( var i = 0; i < mesh.morphTargetInfluences.length; ++ i ) {
					...
					for ( var attributeName in geometry.morphAttributes ) {
						...
						// Three.mini-js doesn't support TANGENT yet.
						...
						// Three.mini-js morph attribute has absolute values while the one of glTF has relative values.
						//
		...
		function processNode( object ) {
			...
			// We don't export empty strings name because it represents no-name in Three.mini-js.
			if ( object.name !== '' ) {
