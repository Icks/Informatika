 ...
 *
 * Dependencies
 *  - Ammo.mini-js https://github.com/kripken/ammo.js
 *
...
THREE.MMDPhysics = ( function () {
	...
	function MMDPhysics( mesh, rigidBodyParams, constraintParams, params ) {
		...
		if ( typeof Ammo === 'undefined' ) {
			...
			throw new Error( 'THREE.MMDPhysics: Import ammo.mini-js https://github.com/kripken/ammo.js' );
	 ...
	 *
	 * 1. manage Ammo.mini-js and Three.mini-js object resources and
	...
	Constraint.prototype = {
		...
		_init: function () {
			...
			/*
			 * Currently(10/31/2016) official ammo.mini-js doesn't support
			 * btGeneric6DofSpringConstraint.setParam method.
			 * You need custom ammo.mini-js (add the method into idl) if you wanna use.
