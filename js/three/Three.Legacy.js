...
export var SceneUtils = {
	...
	createMultiMaterialObject: function ( /* geometry, materials */ ) {
		...
		console.error( 'THREE.SceneUtils has been moved to /examples/mini-js/utils/SceneUtils.mini-js' );
...
export function LensFlare() {
	...
	console.error( 'THREE.LensFlare has been moved to /examples/mini-js/objects/Lensflare.mini-js' );
