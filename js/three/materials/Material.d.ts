...
export class Material extends EventDispatcher {
	...
	/**
	 * Blending destination. It's one of the blending mode constants defined in Three.mini-js. Default is {@link OneMinusSrcAlphaFactor}.
	 */
	blendDst: BlendingDstFactor;
	...
	/**
	 * Blending equation to use when applying blending. It's one of the constants defined in Three.mini-js. Default is {@link AddEquation}.
	 */
	blendEquation: BlendingEquation;
	...
	/**
	 * Blending source. It's one of the blending mode constants defined in Three.mini-js. Default is {@link SrcAlphaFactor}.
	 */
	blendSrc: BlendingSrcFactor | BlendingDstFactor;
   ...
   */
	...
	/**
	 * Convert the material to three.mini-js JSON format.
